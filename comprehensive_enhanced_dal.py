...
class ComprehensiveEnhancedClassifier:
    ...
    def train_enhanced_neural_network(self, epochs=30, batch_size=64):
...
def main():
    ...
    X_train_processed, X_val_processed, X_test_processed = classifier.apply_feature_engineering(
        ...
        apply_scaling=True, apply_feature_selection=True, k_best=300
    )
    ...
    nn_model, history = classifier.train_enhanced_neural_network(epochs=20, batch_size=64)
